...
$string['pluginname_setting'] = "Custom block's name";
$string['profile:addinstance'] = 'Add a new block Nuntius Profile';
$string['profile:myaddinstance'] = 'Add a new Nuntius Profile to my home';
